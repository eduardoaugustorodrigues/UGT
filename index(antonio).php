...
<meta charset="utf-8">
        ...
        function noticia($id, $css, $titulo){
            if($css == "verm"){
            $css2 = ' style="text-decoration:none; color:#b50000; font-size: 20px; font-family: inherit; -webkit-margin-before: 1em; -webkit-margin-after: 1em; -webkit-margin-start: 0px; -webkit-margin-end: 0px;"';
            }else if($css == "padr"){
