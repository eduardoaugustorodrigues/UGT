...
<meta charset="utf-8">
        ...
        function noticia($id, $css, $titulo){
            if($css == "verm"){
            $css2 = ' style="text-decoration:none; color:#b50000; font-size: 12px; font-family: inherit;"';
            }else if($css == "padr"){
            $css2 = ' style="text-decoration:none; color:#474747; font-size:13px;"';
            }
			if($css == "verm"){
				if(strlen($titulo)>=40){$pontinhos = '...';}else{$pontinhos='';}
				echo $mostarNoticia = '<span style="display:none;">'.strlen($titulo).'</span><a href="index.php?paginaurl=noticia&n='.$id.'"'.$css2.'>'.$titulo.'. <span style="font-style: italic; font-weight:bold">Leia +</span></a>';
			}else{
        ...
        ?>
<title><?php if($_GET['paginaurl']=="noticia"){ echo $noticia[$_GET['n']]; }else{?>UGT- União Geral dos Trabalhadores Distrito Federal<?php } ?></title>
<style type="text/css">
body {
...
<body>
    <div id="tudo">
        ...
        <div class="menuTopo">
            ...
            <span>|</span>
            <a href="?paginaurl=secretarias">Secretarias</a>
            <span>|</span>
            ...
            <a href="?paginaurl=ver-documentos">Documentos</a>
             <span>|</span>
            <a href="?paginaurl=agenda">Agenda</a>
             <span>|</span>
        ...
        <div class="areaSlide">
            <div id="slide">
                <iframe name="slide" src="slide-topo.php" scrolling="no" frameborder="0" class="cssiframe" allowTransparency="true"></iframe>
            </div>
        </div>
        ...
        <div style="float:left; width:622px; margin-bottom:5px;"><?php if(@$_GET[paginaurl]==""){ ?>
            <div style="float:left; width:622px; background:#f0f0f0;">
                <div style="float:left; width:582px; color:#474747; font-size:22px; font-weight:500; padding-top:15px;">&nbsp;Destaques</div>
                <div style="float:right; width:40px; height:41px;"><img src="img/detalhe.png" width="40" height="41"></div>  
                
    			<div style="width:100%;clear:both; text-align:center; padding-top:5px;">
            	<iframe name="slidenoticia" src="slide-noticia.php" scrolling="no" frameborder="0" style="border:none;	overflow-x:hidden; overflow-y:hidden; width:612px; height:269px;" allowTransparency="true" align="left"></iframe>
                </div>

			<?php /*     <div style="width:100%;clear:both; text-align:center; padding-top:10px;">
        <a href="index.php?paginaurl=noticia&n=420" style="text-decoration:none; font-size:31px; color:#000000;"><img src="img/capa-01-06-2015.jpg" width="588" height="180"  alt=""/></a></div>
                ...
                <div style="width:97%;clear:both; padding-left:8px; color:#474747; font-size:9px; padding-top:1px;">&nbsp;</div>
                
                <hr>
              <div style="float:left; width:247px; padding-top:10px; padding-left:10px; margin-bottom:20px; text-align:justify;">
                ...
                <div style="float:left; width:257px; padding-top:10px; margin-bottom:20px; text-align:justify;">
                    <?php for ($iNot = $totoalNoticias; $iNot >= ($totoalNoticias - 1); $iNot--) {
					$i=$iNot; noticia($i, 'verm', $noticia[$i]); ?>
                    <br>
                    <br>
                ...
                <hr>
            <div style="float:left; width:623px; background:#f0f0f0;">
                <div style="float:left; width:247px; padding-top:10px; padding-left:10px; margin-bottom:20px; text-align:justify;">
                    <?php for ($iNot = $totoalNoticias; $iNot >= ($totoalNoticias - 1); $iNot--) {
					$i=$iNot; noticia($i, 'verm', $noticia[$i]); ?>
                    <br>
            ...
            <div style="float:left; width:623px; padding-top:35px;">
            	<div style="float:left; width:302px; height:380px; background:#f0f0f0;">
                <div style="float:left; width:262px; color:#474747; font-size:22px; font-weight:500; padding-top:15px;">&nbsp;Notícias da Semana</div>
                <div style="float:right; width:40px; height:41px;"><img src="img/detalhe.png" width="40" height="41"></div>
                <?php for ($iNot = $totoalNoticias; $iNot >= ($totoalNoticias - 5); $iNot--) {?>
			...
			else if($_GET['paginaurl']=="slide01"){
				include('slide01.php');
   	  ...
   	  <div style="float:left; width:337px;">
       	<div style="float:left; width:337px;"><img src="img/logo.png" width="337" height="203"><br /><br /><br /></div>
        	...
        	<div style="float:left; width:337px; padding-top:20px;">
            	<div style="text-align:center;">GALERIA DE FOTOS</div>
				<iframe src="slide-menor.php" scrolling="no" align="right" frameborder="0" style="border:none; overflow:hidden; width:313px; height:150px;" allowTransparency="true"></iframe>
        	</div>
       	<div style="float:left; width:337px; padding-top:30px;">
            	<iframe src="http://www.facebook.com/plugins/likebox.php?id=450355301739206&amp;width=313&amp;connections=9&height=240" scrolling="no" align="right" frameborder="0" style="border:none; overflow:hidden; width:313px; height:240px;" allowTransparency="true"></iframe>
        </div>
        	<div style="float:left; width:337px; padding-top:10px; text-align:right;">
                ...
                <br>
                <center>
                <a href="http://www.trabalhodecente.org.br" title="Trabalho decente" target="_blank"><img src="img/trab-docente.jpg" width="289" height="67" alt="" class="load-complete"></a>
                <br>
                <a href="http://sweb1.diretainformatica.com.br:7080/profederacaoweb/index.php?sind=730" title="Boleto" target="_blank"><img src="img/boleto.JPG" width="243" height="43"></a>
                <br>
                <img src="img/filiado.JPG">
                </center>
           </div>
        	<div style="float:left; width:337px;">
            	<a href="http://www.fnpeti.org.br/12dejunho" target="_blank" style="text-decoration:none;"><img src="img/campanha_trabalho_infantil_ugt2.png" border='0' height="425" width="310" style="margin-left:25px"></a>
                <br>
   		</div>
        	<div style="float:left; width:337px;">
            	<a href="img/final.final.pdf" target="_blank" style="text-decoration:none;"><img src="img/banner-Juventude.jpg" border='0' height="215" width="310" style="margin-left:25px"></a>
                <br>
       		</div>
        ...
        <div style="float:left; margin-top:20px; width:100%; background:#b50000;">
          ...
          <div style="float:left; width:100%;">
            ...
            UGT-DF - UNIÃO GERAL DOS TRABALHADORES DO DISTRITO FEDERAL<br> 
            <br>
            <div style="font-size:12px; color: #FFFFFF; text-align:left; margin-left:2px; width:100%; text-align:center">
            <table border="0" cellpadding="0" cellspacing="0" style="margin-left:270px; margin-top:5px;" align="center">
            <tr>
            <td style="padding-right:3px;">Fone: (61) 3244-0824</td>
            </tr>
            <tr>
            <td style="padding-right:3px;">Endereço: SEP SUL EQ 707/907 - Conj. E N. 10 Sl 512, Ed. San Marino.</td>
            </tr>
            <tr>
            <td style="padding-right:3px;">CEP: 70.390-078 - Brasília/DF</td>
            </tr>
            <tr>
            <td style="padding-right:3px;">E-mail:  ugtbrasilia@gmail.com / ugtdf@ugtdf.org.br</td>
            </tr>
            <tr>
              <td style="padding-right:3px;">Site: www.ugtdf.org.br</td>
            </tr>
            <tr>
            <td style="padding-right:3px;">Facebook: facebook.com/ugtbrasilia </td>
            </tr>
            <tr>
            <td style="padding-right:3px;">Twitter: twitter.com/UGTDF</td>
            </tr>
            </table>
            </div>
