...
<meta charset="utf-8">
        ...
        function noticiaVer($id, $css, $titulo){
            $css2 = ' style="text-decoration:none; color:#b50000; font-size:18px;"';
            echo $mostarNoticia = '<a href="index.php?paginaurl=noticia&n='.$id.'"'.$css2.'>'.substr($titulo,0,40).'...</a>';
            return $mostarNoticia;
        }
        ?>
    ...
    <div id="tudo">
        ...
        <a href="index.php?paginaurl=noticia&n=420" style="text-decoration:none; font-size:31px; color:#000000;"><img src="img/capa-01-06-2015.jpg" width="588" height="180"  alt=""/></a></div>
              ...
              <div style="float:left; width:247px; padding-top:10px; padding-left:10px; margin-bottom:20px; text-align:justify;">
					...
					$i=$iNot; noticiaVer($i, 'verm', $noticia[$i]); ?>
                    <br>
                    <br>
